        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-3 sm:py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <h2 className="text-lg sm:text-2xl font-bold text-indigo-600">Rajaram Gurukul</h2>
            </div>
            <UserButton />
          </div>
        </div>
      ...
      <main className="max-w-4xl mx-auto px-3 sm:px-4 py-4 sm:py-8">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <button
            ...
            className="mt-3 sm:mt-4 px-4 sm:px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm sm:text-base"
          >
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-8">
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 border border-gray-100">
            <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4">Event & Contact Information</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              <div>
                ...
                >
                  ...
                  <option value="spiritual-gathering-dec">Spiritual Gathering - Dec 2024</option>
                  <option value="annual-utsav-jan">Annual Utsav - Jan 2025</option>
                  <option value="monthly-satsang">Monthly Satsang</option>
                </select>
              </div>
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 border border-gray-100">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 gap-3 sm:gap-0">
              <h3 className="text-lg sm:text-xl font-semibold">Participants ({participants.length})</h3>
              <button
                type="button"
            ...
            <div className="space-y-4 sm:space-y-6">
              {participants.map((participant, index) => (
                <div key={participant.id} className="border border-gray-200 rounded-lg sm:rounded-xl p-3 sm:p-4">
                  {/* Participant Header */}
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-3 sm:mb-4 gap-3 sm:gap-0">
                    <div className="flex items-center space-x-2 sm:space-x-4">
                      <button
                        ...
                        className="text-base sm:text-lg font-medium text-gray-800 hover:text-indigo-600 text-left"
                      >
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-2 w-full sm:w-auto">
                      {index > 0 && (
                        <select
                          ...
                          className="text-xs sm:text-sm px-2 py-1 border rounded w-full sm:w-auto"
                        >
                      ...
                      {participants.length > 1 && (
                        <button
                          ...
                          className="text-red-600 hover:text-red-800 px-2 py-1 text-xs sm:text-sm border border-red-300 rounded w-full sm:w-auto"
                        >
                          Remove
                        </button>
                      )}
                    ...
                    <div className="space-y-3 sm:space-y-4">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4">
                        <input
                          ...
                          className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 text-sm sm:text-base"
                          required
                        />
                        <input
                          type="number"
          ...
          <div className="text-center pb-4">
            <button 
              type="submit"
              className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg sm:rounded-xl font-bold text-base sm:text-lg hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl"
            >
              Submit Registration ✨
            </button>
          </div>
